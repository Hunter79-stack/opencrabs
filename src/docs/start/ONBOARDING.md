---
summary: "First-run onboarding flow for OpenCrab (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenCrab">
...
<Step title="CLI">
  ...
  The app can install the global `opencrab` CLI so terminal
